...
exports.objectiveStateUpdate = async (req, res) => {
  try {
    ...
    const { goalId, objNum, day, newState } = req.body;
    ...
    const dayIndex = getUser.selectedGoals[goalIndex].objectiveState.findIndex(
      (obj) => obj.day == day
    );
    ...
    getUser.selectedGoals[goalIndex].objectiveState[dayIndex].completeness[
      objNum
    ] = newState;
