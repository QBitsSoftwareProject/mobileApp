...
const TimeSlot = (props) => {
  ...
  const handlePlus = () => {
    if (textInputValue1 == "" || textInputValue2 == "") {
      ...
      !validateTimeFormat(textInputValue1) ||
      !validateTimeFormat(textInputValue2)
    ) {
      ...
      props.onChange({ from: textInputValue1, to: textInputValue2 });
    ...
    <View>
      ...
      <View style={styles.timeBox}>
        <Text style={styles.timeText}>
          Time slot - {countVal}
          {isEmpty && <Text style={{ color: "red" }}> * </Text>}:
        </Text>
        ...
        {!isPlusVisible && <View style={styles.hiddenImg}></View>}
      </View>
    </View>
  );
};
