...
//       }
//     },
//     [onDateSelect, setArrayController]
//   );
...
//   // call the get Journal by date function
//   useEffect(() => {
...
//           setJournalArray(journalsByDate);
//           setArrayController(1);
//         }
//       } catch (error) {
//         console.error(error);
...
//     fetchJournals();
//   }, [selectedDate, showAllJournals, setJournalArray, setArrayController]);

//   // call the getJournalByUserId function
//   useEffect(() => {
//     const fetchAllJournals = async () => {
//       try {
//         if (showAllJournals) {
//           const journalsByUser = await getJournalsByUserId();
//           setJournalArray(journalsByUser);
//           setArrayController(1);
//         }
//       } catch (error) {
//         console.error(error);
...
//     fetchAllJournals();
//   }, [showAllJournals, setJournalArray, setArrayController]);
