...
const SchedulePopUp = ({
  ...
  useEffect(() => {
    if (monday.length > 0) {
      ...
      setavailableDays((prevState) =>
        prevState.filter((day) => day !== "monday")
      );
    }
  }, [monday]);
  ...
  useEffect(() => {
    if (tuesday.length > 0) {
      ...
      setavailableDays((prevState) =>
        prevState.filter((day) => day !== "tuesday")
      );
    }
  }, [tuesday]);
  ...
  useEffect(() => {
    if (wednesday.length > 0) {
      ...
      setavailableDays((prevState) =>
        prevState.filter((day) => day !== "wednesday")
      );
    }
  }, [wednesday]);
  ...
  useEffect(() => {
    if (thursday.length > 0) {
      ...
      setavailableDays((prevState) =>
        prevState.filter((day) => day !== "thursday")
      );
    }
  }, [thursday]);
  ...
  useEffect(() => {
    if (friday.length > 0) {
      ...
      setavailableDays((prevState) =>
        prevState.filter((day) => day !== "friday")
      );
    }
  }, [friday]);
  ...
  useEffect(() => {
    if (saturday.length > 0) {
      ...
      setavailableDays((prevState) =>
        prevState.filter((day) => day !== "saturday")
      );
    }
  }, [saturday]);
  ...
  useEffect(() => {
    if (sunday.length > 0) {
      ...
      setavailableDays((prevState) =>
        prevState.filter((day) => day !== "sunday")
      );
    }
  }, [sunday]);
        ...
        >
          ...
          >
            <ScrollView style={{ height: "70%" }}>
              <DayAndTime
                day="Monday"
                setTimeSlots={setMonday}
                timeSlots={monday}
              ></DayAndTime>
              <DayAndTime
                day="Tuesday"
                setTimeSlots={setTeusday}
                timeSlots={tuesday}
              ></DayAndTime>
              <DayAndTime
                day="Wednesday"
                setTimeSlots={setWednesday}
                timeSlots={wednesday}
              ></DayAndTime>
              <DayAndTime
                day="Thursday"
                setTimeSlots={setThursday}
                timeSlots={thursday}
              ></DayAndTime>
              <DayAndTime
                day="Friday"
                setTimeSlots={setFriday}
                timeSlots={friday}
              ></DayAndTime>
              <DayAndTime
                day="Saturday"
                setTimeSlots={setSaturday}
                timeSlots={saturday}
              ></DayAndTime>
              <DayAndTime
                day="Sunday"
                setTimeSlots={setSunday}
                timeSlots={sunday}
              ></DayAndTime>
            </ScrollView>
            <TouchableOpacity
