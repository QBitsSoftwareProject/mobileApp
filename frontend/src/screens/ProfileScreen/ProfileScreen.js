...
const ProfileScreen = () => {
  ...
  const [isPopupVisibleSpecialization, setPopupVisibleSpecialization] = useState(false);
  const [isPopupVisibleQualification, setPopupVisibleQualification] = useState(false);
...
const handleUpdateSpecialization = async (newSpecialization) => {
  try {
    const updatedUser = await updateADoctor({ specialization: newSpecialization });
    // Handle success, maybe update local state with the updated user data
    console.log("Profile Bio updated successfully:");
  } catch (error) {
    // Handle error
...
const handleUpdateQualification = async (newQalification) => {
  try {
    const updatedUser = await updateADoctor({ qualification:newQalification});
    // Handle success, maybe update local state with the updated user data
  ...
  return (
    ...
    <View style = {styles.imageEdit}>
      ...
      <View style = {{width: 130,
            ...
            overflow: 'hidden',}}>
              {profilePicture && (
      <ImageBackground source={{uri: profilePicture}} style = {{width:130, height:130 , borderRadius:60}}>
    ...
    <Text style = {{fontSize:12,color:'#868686'}}>User ID : {userId}</Text>
    <Text style = {{fontSize:12,color:'#868686'}}>Account Type : {accountType}</Text>
    ...
    <View style = {styles.editInfo}>
      ...
      <TextCard title = "Name" subText= {fullName} icon={require('../../assets/images/ProfileIcons/name.png')} function = {togglePopupName}/>
      
      <TextCard title = "User Name" subText= {userName} icon={require('../../assets/images/ProfileIcons/userName.png')} function ={togglePopupUserName}/>

      <TextCard title = "Email" subText= {email} icon={require('../../assets/images/ProfileIcons/email.png')} function ={togglePopupEmail}/>

      <TextCard title = "Contact Number" subText= {contactNumber} icon={require('../../assets/images/ProfileIcons/contact.png')} function = {togglePopupContact}/>

      <TextCard title = "Address" subText= {address} icon={require('../../assets/images/ProfileIcons/address.png')} function = {togglePopupAddress}/>

      <TextCard title = "City" subText= {city} icon={require('../../assets/images/ProfileIcons/city.png')} function ={togglePopupCity}/>

      <TextCard title = "Country" subText= {country} icon={require('../../assets/images/ProfileIcons/country.png')} function = {togglePopupCountry}/>

        {userRole === 'doctor' && (

          <>
      <TextCard title = "Bio" subText= {bio} icon={require('../../assets/images/ProfileIcons/bio.png')} function = {togglePopupBio}/>

      <TextCard title = "specialization" subText= {specialization} icon={require('../../assets/images/ProfileIcons/specialization.png')} function = {togglePopupSpecialization}/>

      <TextCard title = "Qualification" subText= {qualification} icon={require('../../assets/images/ProfileIcons/qualification.png')} function = {togglePopupQualification}/>

      <TextCard title = "Available Time" subText= "click edit to view schedule" icon={require('../../assets/images/ProfileIcons/time.png')} function = {togglePopupSchedule}/>
    ...
    <BioEditPopUp isVisible={isPopupVisibleName} onClose={togglePopupName} title = "Edit Name" previousText = {fullName} update = {setFullName} updateFunction = {handleUpdateFullName}/>
    <BioEditPopUp isVisible={isPopupVisibleUserName} onClose={togglePopupUserName} title = "Edit User Name" previousText = {userName} update = {setUserName} updateFunction = {handleUpdateUserName}/>
    <BioEditPopUp isVisible={isPopupVisibleEmail} onClose={togglePopupEmail} title = "Edit Email" previousText = {email} update = {setEmail} updateFunction = {handleUpdateEmail}/>
    <BioEditPopUp isVisible={isPopupVisibleContact} onClose={togglePopupContact} title = "Edit Contact Number" previousText = {contactNumber} update = {setContactNumber}  updateFunction =  {handleUpdateContactNumber}/>
    <BioEditPopUp isVisible={isPopupVisibleAddress} onClose={togglePopupAddress} title = "Edit Address" previousText = {address} update = {setAddress}  updateFunction = {handleUpdateAddress}/>
    <BioEditPopUp isVisible={isPopupVisibleCity} onClose={togglePopupCity} title = "Edit City" previousText = {city} update = {setCity} updateFunction = {handleUpdateCity}/>
    <BioEditPopUp isVisible={isPopupVisibleCountry} onClose={togglePopupCountry} title = "Edit Country" previousText = {country} update = {setCountry} updateFunction = {handleUpdateCountry}/>  
    <ProfilePopup isVisible={isPopupVisibleProPic} onClose={togglePopupProPic} setProPic={setProPic} updateFunction ={handleProPicUpload}/>
    <BioEditPopUp isVisible={isPopupVisibleBio} onClose={togglePopupBio} title = "Edit Bio" previousText = {bio} update = {setBio} updateFunction = {handleUpdateBio}/>
    <BioEditPopUp isVisible={isPopupVisibleSpecialization} onClose={togglePopupSpecialization} title = "Edit Specialization" previousText = {specialization} update = {setSspecialization} updateFunction = {handleUpdateSpecialization}/>
    <BioEditPopUp isVisible={isPopupVisibleQualification} onClose={togglePopupQualification} title = "Edit Qualification" previousText = {qualification} update = {setQualification} updateFunction = {handleUpdateQualification}/> 
    <SchedulePopUp 
