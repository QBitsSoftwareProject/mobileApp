  ...
  return (
    <View>
      <View>
        <HeaderSub
          headLine="Result"
          subHeadLine="understand and manage your stress better."
          back="HomeScreen"
        />
      </View>
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1, paddingBottom: 500 }}>
        <Text style={styles.pccText}>
          This numerical assessment reflects your current stress quotient
          measured via the Perceived Stress Scale (PSS).
        </Text>
        ...
        <ImageBackground
          source={require("../../assets/images/resultScreen/resultScreenBack.png")}
          style={styles.backgroungimg}
        >
          <Text style={styles.textStressLvl}>Your Stress Level is</Text>

          <View style={styles.container}>
            <Text style={styles.text}>{lastMark}</Text>
          </View>
        ...
        <Text style={styles.pccText}>
          A score between 0 and 15 indicates low stress, 15 to 27 signifies
          moderate stress, while a range of 27 to 40 indicates high stress
          levels.
        </Text>
        ...
        >
          ...
          >
            <Text style={{ color: "black", fontSize: 14, marginLeft: 50 }}>
              History
            </Text>
          </TouchableOpacity>
