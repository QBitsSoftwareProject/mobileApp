    ...
    <SafeAreaView>
      <ScrollView>
        ...
        <View style={{ paddingHorizontal: 25 }}>
          ...
          <Text style={styles.description}>
            We collect, Personal Information,Mood tracking data, journal
            entries, task completion status, interaction with community features
          </Text>
          ...
          <Text style={styles.description}>
            ...
            relevant tasks, Send reminders and motivational messages, Analyze
            and improve our services, Ensure the security of your data
          </Text>

          <Text style={styles.title}>3. Sharing Your Information</Text>
          <Text style={styles.description}>
            We do not sell your personal information. We may share your data
            with third-party service providers who help us operate the app, only
